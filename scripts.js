...
BananaBread = newRecipe("Banana Bread", "Dawson Bolen", "bananabread.jpg", "ingredientsA.html", "equipmentA.html", "directionsA.html");
ChocolateChipCookies = newRecipe("Chocolate Chip Cookies", "Aida Must", "chocolatechipcookies.jpg", "ingredientsB.html", "equipmentB.html", "directionsB.html");
AnotherRecipe = new Recipe();
AppleButterSnickerdoodles = newRecipe("Apple Butter Snickerdoodles", "Ethan Breymeyer", "snickerdoodle.jpg", "ingredientsC.html", "equipmentC.html", "directionsC.html");
AnotherRecipe = new Recipe();
